...
const CategoryItem = ({ postsByCategory, category }: any) => (
  <div>
    <h1>
    ...
    <ul>
      {postsByCategory.map(({ id, fields, excerpt }: any) => {
        return (
          <li key={id}>
            <h1>
...
const CategoryList = ({ postsByCategories }: any) => (
  <div>
    <h1>Categories</h1>
    <ul>
...
export default function Categories({ data: { site }, pageContext }: any) {
  return (
    <Layout site={site}>
